								...
								<div className="card">
									...
									<div className="card-footer d-flex justify-content-between align-items-center flex-wrap">
										<div className="mb-2">
											...
											<p className="mb-0 text-black font-w500 mt-1">16-02-2023, 15:15 PM</p>
										</div>
										<div className="mb-2">
											<span className="me-2"><i className="fas fa-user-tie me-2"></i>HR/Admin</span>{" "}
											<Link to={"#"} className="btn btn-primary btn-sm apply-job"><i className="far fa-check-circle me-2"></i>Apply Now</Link>
										</div>
									</div>
								</div>
							</div>
